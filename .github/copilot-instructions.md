...
- 001-core-microservice: Added Go 1.25+ (Listing, Media, Booking), Java 21+ (Payment, Review, Favorites), Python 3.11+ (Notification, User, Analytics) + Go web framework (Gin/Mux), Spring Boot, FastAPI/Flask, Kafka Client
